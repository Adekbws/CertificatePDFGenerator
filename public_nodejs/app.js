...
var _initial = __webpack_require__(24);

var _initial2 = _interopRequireDefault(_initial);

var _Html = __webpack_require__(90);
...
var ImageRouter = __webpack_require__(124);
...
app.use(_express2.default.urlencoded({ extended: true })); // to support URL-encoded bodies
...
app.get('*', function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res) {
    var scripts, context, store, appMarkup, html;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            context = {};
            store = (0, _redux.createStore)(_reducers2.default, { eventsStore: _initial2.default }, (0, _redux.applyMiddleware)(_reduxThunk2.default));
            ...
            html = _server2.default.renderToStaticMarkup(_react2.default.createElement(_Html2.default, { children: appMarkup, scripts: scripts, initialState: _initial2.default }));
...
var _eventsReducer = __webpack_require__(21);
...
var clearFileNames = function clearFileNames(files_array) {
  var cleredNames = [];
  files_array.forEach(function (el, i) {
    var clearFontName = el.split('.').slice(0, -1).join('.');
...
var initial_images = fs.readdirSync(__dirname + '/../src/img/initial');

initial_images.map(function (item, key) {
...
var font_files = fs.readdirSync(__dirname + '/../src/fonts/');
var background_files = fs.readdirSync(__dirname + '/../src/img/backgrounds');

var fontsToSelect = clearFileNames(font_files);

fontsToSelect.map(function (item, key) {

  var fontUrl_woff = filePath(fonts, './' + item + '.woff');
  var fontUrl_woff2 = filePath(fonts, './' + item + '.woff2');
  var fontUrl_ttf = filePath(fonts, './' + item + '.ttf');

  var data = ' @font-face{font-family:' + item + '; font-weight:normal; font-style:normal;\n    src:' + (fontUrl_woff ? 'url(\'../../' + fontUrl_woff + '\') format(\'woff\')' : '') + '\n    ' + (fontUrl_woff2 ? ', url(\'../../' + fontUrl_woff2 + '\') format(\'woff2\')' : '') + '\n    ' + (fontUrl_ttf ? ', url(\'../../' + fontUrl_ttf + '\') format(\'ttf\')' : '') + '\n  ;}';

  fontsCssFile.write(data); // append string to your file  
});
fontsCssFile.end();

var initColor = { r: 255, g: 255, b: 255, a: 1 };
var textProps = [{ text: '<p>Certyfikat</p>', fontName: 'Aquatico-Regular', fontColor: initColor, fontSize: "85", p_t: 196, active: true }, { text: '<p>Franek Dolas</p>', fontName: 'COUTURE-Bold', fontColor: initColor, fontSize: "55", m_t: "30", p_t: 325 }, { text: '<p>ukończył kurs</p>', fontName: 'Roboto-Regular', fontColor: initColor, fontSize: "25", m_t: "60", p_t: 480 }, { text: '<p>Zaawansowany programista REACT</p>', fontName: 'Roboto-Bold', fontColor: initColor, fontSize: "35", m_t: "20", p_t: 525 }, { text: '<p>Zorganizowany przez:</p>', fontName: 'Roboto-Regular', fontColor: initColor, fontSize: "25", m_t: "40", p_t: 621 }, { text: '<p>IT SCHOOL</p>', fontName: 'Roboto-Bold', fontColor: initColor, fontSize: "35", m_t: "20", p_t: 664 }, { text: '<p>W zakresie:</p>', fontName: 'Roboto-Regular', fontColor: initColor, fontSize: "25", m_t: "40", p_t: 721 }, { text: '<p>Programowania typu full-stack zapewniającego, kompleksową wiedzę i umiejętności z zakresu front-end i back-end. Poznając najważniejsze i najbardziej popularne moduły takie jak:</p>', fontName: 'Roboto-Regular', fontColor: initColor, fontSize: "25", m_t: "40", p_t: 765 }, { text: '<p>-Styled Components<br>-React Redux<br>-Prop Types<br>-i inne...</p>', fontName: 'Roboto-Regular', fontColor: initColor, fontSize: "25", m_t: "20", align: "left", boxAlign: "left", p_t: 928 }, { text: '<p>Projekt Generatora w trakcie rozwoju</p>', fontName: 'Roboto-Regular', fontColor: { r: 223, g: 0, b: 36, a: 1 }, fontSize: "25", m_t: "40", p_t: 1118 }];
...
var images = [{ url: '/uploads/crown.png', p_t: 24, width: 200 }, { url: '/uploads/crown_line.png', p_t: 410, width: 700 }, { url: '/uploads/crown_cert.png', p_t: 1218, width: 200 }, { url: '/uploads/white_signature.png', p_t: 1218, p_l: 190, width: 255 }];
...
var initialState = { font_files: fontsToSelect, background_files: background_files, images: images, textProps: textProps, activeOptions: activeOptions, cert_background: 'crown.jpg', cssPaths: cssPaths };
...
var map = {
	"./101StaRStuDDeD.ttf": 27,
	"./101StaRStuDDeD.woff": 28,
	"./101StaRStuDDeD.woff2": 29,
	"./AbrahamLincoln.ttf": 30,
	"./AbrahamLincoln.woff": 31,
	"./AbrahamLincoln.woff2": 32,
	"./AirAmericana.ttf": 33,
	"./AirAmericana.woff": 34,
	"./AirAmericana.woff2": 35,
	"./AlwaysInMyHeart.ttf": 36,
	"./AlwaysInMyHeart.woff": 37,
	"./AlwaysInMyHeart.woff2": 38,
	"./Andriko.ttf": 39,
	"./Andriko.woff": 40,
	"./Andriko.woff2": 41,
	"./Aquatico-Regular.ttf": 42,
	"./Aquatico-Regular.woff": 43,
	"./Aquatico-Regular.woff2": 44,
	"./Blacklisted.ttf": 45,
	"./Blacklisted.woff": 46,
	"./Blacklisted.woff2": 47,
	"./COUTURE-Bold.ttf": 48,
	"./COUTURE-Bold.woff": 49,
	"./COUTURE-Bold.woff2": 50,
	"./CampusRelief.ttf": 51,
	"./CampusRelief.woff": 52,
	"./CampusRelief.woff2": 53,
	"./ChubGothic.ttf": 54,
	"./ChubGothic.woff": 55,
	"./ChubGothic.woff2": 56,
	"./ElevatePERSONALUSEONLY.ttf": 57,
	"./ElevatePERSONALUSEONLY.woff": 58,
	"./ElevatePERSONALUSEONLY.woff2": 59,
	"./Haymaker.ttf": 60,
	"./Haymaker.woff": 61,
	"./Haymaker.woff2": 62,
	"./LeGrimoireduBonheur.ttf": 63,
	"./LeGrimoireduBonheur.woff": 64,
	"./LeGrimoireduBonheur.woff2": 65,
	"./Mohave.ttf": 66,
	"./Mohave.woff": 67,
	"./Mohave.woff2": 68,
	"./Morracle.ttf": 69,
	...
	"./NarniaBLL.woff": 73,
	"./NarniaBLL.woff2": 74,
	"./Nickainley-Normal.ttf": 75,
	"./Nickainley-Normal.woff": 76,
	"./Nickainley-Normal.woff2": 77,
	"./Roboto-Bold.ttf": 78,
	"./Roboto-Bold.woff": 79,
	"./Roboto-Bold.woff2": 80,
	"./Roboto-Light.ttf": 81,
	"./Roboto-Light.woff": 82,
	"./Roboto-Light.woff2": 83,
	"./Roboto-Regular.ttf": 84,
	"./Roboto-Regular.woff": 85,
	"./Roboto-Regular.woff2": 86,
	"./SheAlwaysWalkAloneDemo.ttf": 87,
	"./SheAlwaysWalkAloneDemo.woff": 88,
	"./SheAlwaysWalkAloneDemo.woff2": 89
};
...
module.exports = __webpack_require__.p + "a72652e97e39b236b3fe107e61243798.ttf";

/***/ }),
/* 28 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "371f51acbb84b0823d05d97508a3ee45.woff";

/***/ }),
/* 29 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "f3228ecc5c277968794e33663f5b523b.woff2";

/***/ }),
/* 30 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "4a7bcd6842590cc4ff730b1b905d5535.ttf";

/***/ }),
/* 31 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "e147c8399f3a361d60242183c700cfbd.woff";

/***/ }),
/* 32 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "612053dea782587d869bddca9df00687.woff2";

/***/ }),
/* 33 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "10bfa95468a88110d07b4b4db20d79fe.ttf";

/***/ }),
/* 34 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "0667c5655b2f40aca671ac00372477d6.woff";

/***/ }),
/* 35 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "f507ba7ba2af028b06508fdd2610d635.woff2";

/***/ }),
/* 36 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "a898531e9089881c50d7f31d76c0ecf1.ttf";

/***/ }),
/* 37 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "fec5e7e02be3d4c3c28e1f365351f989.woff";

/***/ }),
/* 38 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "2c4364ea5a322d1100562d3e96572903.woff2";

/***/ }),
/* 39 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "8b6b4e73920506372b1858ffc8305170.ttf";

/***/ }),
/* 40 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "435a5692fc1fcf3009b2f2a02f097db8.woff";

/***/ }),
/* 41 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "badfb93817c3ff2736efdd68a73382c4.woff2";

/***/ }),
/* 42 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "a9b9a9fe60469f4799404e88bf9d20fc.ttf";

/***/ }),
/* 43 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "4f93dd1d20579589ebafa13f7b2fda6d.woff";

/***/ }),
/* 44 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "6e2641f9ed215f979b0ffcf571d90ec8.woff2";

/***/ }),
/* 45 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "21018bd943f045fe2dc45b89e11d7e02.ttf";

/***/ }),
/* 46 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "72f8273e78d672f593b74cf92e0c50ef.woff";

/***/ }),
/* 47 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "1c00b4ff3b35e93ad4dce441816aff95.woff2";

/***/ }),
/* 48 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "6be1dd801509d83a43ba5aeca00114c8.ttf";

/***/ }),
/* 49 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "56f8931090faf5f90880f870c0bcb4a6.woff";

/***/ }),
/* 50 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "a90a2b299ed70411903337fe4a776b42.woff2";

/***/ }),
/* 51 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "31c37b46fcf3f64350bf0a5979f952bb.ttf";

/***/ }),
/* 52 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "e5d4b0ee57a8182d58df5dee9cb2eb5f.woff";

/***/ }),
/* 53 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "fcb5ec3d8c8da7376e5ddbd68a6c45c7.woff2";

/***/ }),
/* 54 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "d66fa8a5098820acd1ffb8421718f30d.ttf";

/***/ }),
/* 55 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "138200ed3ea612ac01a949823e388cee.woff";

/***/ }),
/* 56 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "a10f45e8abe3d1b6464e60a1c61d6a0b.woff2";

/***/ }),
/* 57 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "048a225a9af5311823bb8e7a53e5fe0d.ttf";

/***/ }),
/* 58 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "de08dbf33a7dadc38a19d3c0575cfe47.woff";

/***/ }),
/* 59 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "8b4fddf6afa68d58521355589adcd638.woff2";

/***/ }),
/* 60 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "35d535a0d4e655d4c69200ad5361a889.ttf";

/***/ }),
/* 61 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "3bba35194914cfac56d51ab1ea586a17.woff";

/***/ }),
/* 62 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "2219af7d1471abda330f8efec73af0dc.woff2";

/***/ }),
/* 63 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "b5a7d977ae9bcb01172d781f83fb1d06.ttf";

/***/ }),
/* 64 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "75baac188ca511dbf22a8e8ab9395bc9.woff";

/***/ }),
/* 65 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "b942ae67b898d39dabe30a9707ed39b4.woff2";

/***/ }),
/* 66 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "d35e297d2b0ba04a269d994e7880bfee.ttf";

/***/ }),
/* 67 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "552993262ee024d64a864983d0d248a8.woff";

/***/ }),
/* 68 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "7d359ad852c704ac2f1111bfedd306b2.woff2";

/***/ }),
/* 69 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "21468402ad3bc3ffd52b5ea09e39e6b9.ttf";

/***/ }),
/* 70 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "f7ecaa4aa95d58b214453e9cefa3db7a.woff";

/***/ }),
/* 71 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "78cf1b004d39354b3655b078ad315faf.woff2";

/***/ }),
/* 72 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "dec76a3e73798ea7070f7532ca4664b6.ttf";

/***/ }),
/* 73 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "fe1127920088acdc5eb3cc3b0c114a91.woff";

/***/ }),
/* 74 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "f7d448044ba78fe866a0334833bcf7be.woff2";

/***/ }),
/* 75 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "e8e537c2d86c8a4664108b99732b2b8a.ttf";

/***/ }),
/* 76 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "83d162ac3a20b67e8e9e8d5efe8ad29d.woff";

/***/ }),
/* 77 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "ece698e29bf793652cef463c58861736.woff2";

/***/ }),
/* 78 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "e07df86cef2e721115583d61d1fb68a6.ttf";

/***/ }),
/* 79 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "08cb8f79715774f9a6285ee7db2919a3.woff";

/***/ }),
/* 80 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "f3a02e2578bee50e620e515912278bc9.woff2";

/***/ }),
/* 81 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "88823c2015ffd5fa89d567e17297a137.ttf";

/***/ }),
/* 82 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "10ad0f861c0c5807734017c341940649.woff";

/***/ }),
/* 83 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "ed4b08d2702fa26acc324ef1e89ae837.woff2";
...
module.exports = __webpack_require__.p + "94dac78eee406a8c8f0406b69b85ac2b.woff";

/***/ }),
/* 86 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "9feb0110b6dff9ee2b9ebd17f7a1aee6.woff2";

/***/ }),
/* 87 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "429edc9d5b48da428d2a53ff047ad2e7.ttf";

/***/ }),
/* 88 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "b7c35a522e350acf2ebe1dfcca43d727.woff";

/***/ }),
/* 89 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "dd753f99b4ae3ba73652063ce85740d8.woff2";
...
var _reactToastify = __webpack_require__(7);

var _reactBootstrap = __webpack_require__(4);

var _kendoReactPdf = __webpack_require__(94);

var _DragRes = __webpack_require__(95);
...
var background_files = __webpack_require__(116);
...
module.exports = require("@progress/kendo-react-pdf");
...
var _reactDraggable = __webpack_require__(96);

var _reactDraggable2 = _interopRequireDefault(_reactDraggable);

var _reResizable = __webpack_require__(97);
...
// Imports
var urlEscape = __webpack_require__(99);
var ___CSS_LOADER_URL___0___ = urlEscape(__webpack_require__(100));
var ___CSS_LOADER_URL___1___ = urlEscape(__webpack_require__(101));
var ___CSS_LOADER_URL___2___ = urlEscape(__webpack_require__(102));
...
var _SelectFontSize = __webpack_require__(105);

var _SelectFontSize2 = _interopRequireDefault(_SelectFontSize);

var _FontSelect = __webpack_require__(106);
...
var _PosOption = __webpack_require__(13);

var _PosOption2 = _interopRequireDefault(_PosOption);

var _trash = __webpack_require__(109);

var _trash2 = _interopRequireDefault(_trash);

var _tinymceReact = __webpack_require__(110);
...
var _reactColor = __webpack_require__(108);
...
var multer = __webpack_require__(125);
var fs = __webpack_require__(12);
...
ImageRouter.route("/upload-photo").post(function (req, res, next) {
    upload(req, res, function (err) {
        ...
        var fileLocalUrl = "uploads/" + req.file.filename;

        return res.status(200).send({ fileLocalUrl: fileLocalUrl });
    });
});
...
var download = function download(uri, filename, callback) {
    var stream = request({ url: uri, encoding: null, forever: true }, function (err, response, body) {}).pipe(fs.createWriteStream(filename));
    stream.on('finish', callback);
};

ImageRouter.route("/url-photo").post(function (req, res, next) {

    var filepath = __dirname + "/public/uploads/";
    var filename = 'zdjotko' + Date.now() + '.jpg';
    ...
    download(req.body.url, filepath + filename, function () {
        ...
        var fileLocalUrl = "uploads/" + filename;
        return res.status(200).send({ fileLocalUrl: fileLocalUrl });
    });
});
